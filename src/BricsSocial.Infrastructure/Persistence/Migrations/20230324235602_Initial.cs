        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Logo = table.Column<string>(type: "character varying(2097152)", maxLength: 2097152, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Bio = table.Column<string>(type: "character varying(70)", maxLength: 70, nullable: false, defaultValue: ""),
                    About = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: false, defaultValue: ""),
                    SkillTags = table.Column<string>(type: "character varying(409)", maxLength: 409, nullable: false, defaultValue: ""),
                    Photo = table.Column<string>(type: "character varying(2097152)", maxLength: 2097152, nullable: true),
                    CountryId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Offerings = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: false),
